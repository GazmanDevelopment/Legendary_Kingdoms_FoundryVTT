...
export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("foundry_legendary_kingdoms", "macroShorthand");
  ...
  static async createDialog(data={}, options={}) {
    ...
    const templates = collection.filter(a => a.getFlag("foundry_legendary_kingdoms", "isTemplate"));
    ...
    const useEntity = game.foundry_legendary_kingdoms.useEntity;
    ...
    return Dialog.prompt({
      ...
      callback: html => {
        ...
        if ( template ) {
          ...
          delete createData.flags.foundry_legendary_kingdoms.isTemplate;
        }
