...
export class SimpleActorSheet extends ActorSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["foundry_legendary_kingdoms", "sheet", "actor"],
      template: "systems/foundry_legendary_kingdoms/templates/actor-sheet.html",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/foundry_legendary_kingdoms/templates/actor-${this.actor.data.type}-sheet.html`;
  }
  ...
  getData() {
    ...
    context.shorthand = !!game.settings.get("foundry_legendary_kingdoms", "macroShorthand");
